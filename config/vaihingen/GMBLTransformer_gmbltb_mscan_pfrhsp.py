...
from geoseg.models.GMBLTransformer import GMBLTransformer
...
weights_name = "GMBLTransformer_gmbltb_mscan_pfrhsp_vaihingen_ep225"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "GMBLTransformer_gmbltb_mscan_pfrhsp_vaihingen_ep225"
...
#  define the network
net = GMBLTransformer(num_classes=num_classes,pretrained=True)
